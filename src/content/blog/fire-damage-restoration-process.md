...
generated_at: "2026-08-14T06:20:24.055750+00:00"
...
faq: [{"question": "Can I stay in my home during fire damage restoration?", "answer": "It depends on the extent of the damage and which systems are affected. If the fire was small and contained, and utilities are intact, some homeowners remain in unaffected areas. However, if smoke has spread through the HVAC system, if structural areas are compromised, or if significant demolition is underway, staying in the home is generally not safe or practical. Your restoration contractor can help you assess this on a room-by-room basis."}, {"question": "Will my homeowner's insurance cover fire damage restoration?", "answer": "Most standard homeowner's insurance policies cover fire damage, including smoke and water damage caused by firefighting efforts. What they cover specifically \u2014 and at what dollar amount \u2014 depends on your policy limits, your deductible, and whether you have replacement-cost or actual-cash-value coverage. Filing promptly, documenting everything before cleanup begins, and working with a restoration company that provides detailed documentation and communicates technical scope information directly with your adjuster will give your claim the best foundation."}, {"question": "How long does smoke smell last after a fire, and can it be fully removed?", "answer": "Smoke odor can persist for months or longer if only surface cleaning is done, because the compounds that cause the smell penetrate porous materials \u2014 drywall, wood framing, insulation, upholstery, and even concrete. Professional remediation using thermal fogging, ozone treatment, or hydroxyl generators neutralizes those compounds rather than masking them. Whether a specific item or material can be fully deodorized depends on how deeply the smoke penetrated and how long it sat before treatment began."}, {"question": "What's the difference between fire damage restoration and simply repainting or remodeling after a fire?", "answer": "Repainting or remodeling without proper remediation first is one of the most common and costly mistakes after a fire. Painting over soot-stained walls traps the odor and the acidic residue, which continues to degrade the surface underneath. Rebuilding over wet or smoke-contaminated materials can lead to mold growth and persistent odor that requires tearing out the new work to address. Restoration \u2014 cleaning, drying, and removing unsalvageable materials down to sound substrate \u2014 has to happen before reconstruction begins."}]
...
### 1. Emergency Stabilization (Hours 1–24)
...
This is where fire restoration diverges most sharply from what a homeowner can do on their own. Soot is not dirt. It's an acidic, oily compound that smears when wiped incorrectly and re-deposits on surfaces it was just removed from if airflow isn't controlled.
...
- **Don't enter until cleared.** Even a fire that looked contained to one room can leave the rest of the structure compromised by heat, smoke, or water damage to load-bearing elements.
- **Don't run your HVAC.** If smoke entered the system, running it circulates soot through every room in the house.
- **Don't wipe soot with a wet cloth.** It smears and sets. Dry sponges first.
- **Don't throw away damaged items before your adjuster documents them.** Discarding contents before the insurance inventory is complete can reduce your claim.
- **Don't assume the smell will air out.** Smoke odor compounds bond to porous materials. Ventilation alone doesn't remove them.
...
Air Care Restoration handles both fire damage and smoke damage restoration in Abilene and the surrounding area. If you're in the middle of this situation and need to talk through next steps, call (325) 339-8723.

## The Timeline: What to Expect

There's no universal timeline, but a rough framework helps set expectations:

- **Day 1–2:** Emergency stabilization, board-up, initial documentation, water extraction begins
- **Days 2–7:** Structural drying continues; smoke and soot remediation underway
