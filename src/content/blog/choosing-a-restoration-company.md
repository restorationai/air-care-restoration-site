...
A legitimate restoration company will answer these questions without hesitation. Evasion or pressure to skip this step is itself a red flag.
...
- **No local address or verifiable history.** A company with a physical presence in Abilene that has been operating long enough to have a track record is easier to hold accountable than an out-of-state crew that arrived after a storm.
- **Reluctance to provide references or proof of licensing.** Legitimate companies expect these questions.

## How the Restoration Process Should Actually Work
